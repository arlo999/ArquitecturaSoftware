...
\mbox{\hyperlink{classsf_1_1_ftp}{sf\+::\+Ftp}} is a very simple FTP client that allows you to communicate with a FTP server. The FTP protocol allows you to manipulate a remote file system (list files, upload, download, create, remove, ...).
...
\DoxyCodeLine{    std::cout << \textcolor{stringliteral}{"{}Working directory: "{}} << directory.\mbox{\hyperlink{classsf_1_1_ftp_1_1_directory_response_a311575c5c50905219025acfa73de67e2}{getDirectory}}() << std::endl;}
\DoxyCodeLine{}
...
\DoxyCodeLine{response = ftp.\mbox{\hyperlink{classsf_1_1_ftp_a0402d2cec27a197ffba34c88ffaddeac}{upload}}(\textcolor{stringliteral}{"{}local-\/path/file.txt"{}}, \textcolor{stringliteral}{"{}files"{}}, \mbox{\hyperlink{classsf_1_1_ftp_a1cd6b89ad23253f6d97e6d4ca4d558cbac9e544a22dce8ef3177449cb235d15c2}{sf::Ftp::Ascii}});}
\DoxyCodeLine{\textcolor{keywordflow}{if} (response.\mbox{\hyperlink{classsf_1_1_ftp_1_1_response_a5102552955a2652c1a39e9046e617b36}{isOk}}())}
...
\DoxyCodeLine{\textcolor{keywordflow}{if} (response.\mbox{\hyperlink{classsf_1_1_ftp_1_1_response_a5102552955a2652c1a39e9046e617b36}{isOk}}())}
\DoxyCodeLine{    std::cout << \textcolor{stringliteral}{"{}Feature list:\(\backslash\)n"{}} << response.\mbox{\hyperlink{classsf_1_1_ftp_1_1_response_a4af82a0b3620c90558390e1f600abc05}{getMessage}}() << std::endl;}
\DoxyCodeLine{}
...
While the most often used commands are provided as member functions in the \mbox{\hyperlink{classsf_1_1_ftp}{sf\+::\+Ftp}} class, this method can be used to send any FTP command to the server. If the command requires one or more parameters, they can be specified in {\itshape parameter}. If the server returns information, you can extract it from the response using \mbox{\hyperlink{classsf_1_1_ftp_1_1_response_a4af82a0b3620c90558390e1f600abc05}{Response\+::get\+Message()}}.
...
\item 
Externals/sfml/include/\+SFML/\+Network/Ftp.\+hpp\end{DoxyCompactItemize}
