...
\mbox{\hyperlink{classsf_1_1_http}{sf\+::\+Http}} is a very simple HTTP client that allows you to communicate with a web server. You can retrieve web pages, send data to an interactive resource, download a remote file, etc. The HTTPS protocol is not supported.
...
\item 
Externals/sfml/include/\+SFML/\+Network/Http.\+hpp\end{DoxyCompactItemize}
